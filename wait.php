...
<body>
	...
	<section class="">
		...
		?>
			...
			<section class="caption">
				<h2 class="caption" style="text-align: center">Every Occassion deserves a special car</h2>
				<h3 class="properties" style="text-align: center">From Land Cruisers to Range Rovers</h3>
			</section>
	...
	<footer>
		...
		<div class="copyrights wrapper">
			Copyright &copy; <?php echo date("Y")?> All Rights Reserved | Designed by Joseph
		</div>
	</footer><!--  end footer  -->
