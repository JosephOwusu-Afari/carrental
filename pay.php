			...
			<ul class="properties_list">
				...
				<?php
						if(isset($_POST['pay'])){
							...
							$qry = "UPDATE client SET mpesa = '$mpesa', car_id = '$_GET[id]' WHERE id_no = '$id_no'";
							// $sel = "SELECT * FROM cars WHERE car_id = '$_GET[id]'";
							// $qry1 = "INSERT INTO hire (client_id, car_id, status) VALUES('$id_no', '$_GET[id]', 'AVAILABLE')";
